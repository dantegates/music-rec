...
TRAIN_DIR = os.path.join(_dir, 'data/train')
TEST_DIR = os.path.join(_dir, 'data/test')
TRAIN_PROC_DIR = os.path.join(_dir, 'data/train_proc')
TEST_PROC_DIR = os.path.join(_dir, 'data/test_proc')
